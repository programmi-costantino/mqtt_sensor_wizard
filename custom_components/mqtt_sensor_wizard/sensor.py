...
class MqttWizardSensor(SensorEntity):
    """Entità sensore MQTT dinamica compatibile con paho-mqtt 2.x."""
    ...
    def _setup_remote_broker(self):
        ...
        try:
            ...
            # Obbligatorio specificare CallbackAPIVersion.VERSION1
            ...
            _LOGGER.info("Connesso al broker remoto: %s", self._attr_name)
